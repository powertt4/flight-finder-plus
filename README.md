...
Build the requested Flight Price Notifier v1: public dark purple landing page, email/password sign-up/sign-in/sign-out using Lovable Cloud auth with confirmation disabled if supported, and protected /app placeholder dashboard. Do not create custom database tables; use only default auth users. Follow the attached Lovable and Supabase best-practice guidance.
